      ...
      <div className="receipt-header text-center">
        ...
        {settings?.printLogo !== false && (
          <div className="receipt-logo-wrap flex justify-center my-1">
            <img src={settings?.logoUrl && settings.logoUrl !== "null" && settings.logoUrl !== "" ? settings.logoUrl : omnisystemLogo} alt="شعار المطعم" className="receipt-logo" style={{ maxHeight: '18mm', maxWidth: '45mm', objectFit: 'contain' }} onError={(e) => { e.currentTarget.src = omnisystemLogo; }} />
          </div>
        )}
