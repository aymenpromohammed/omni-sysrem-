  ...
  const allSystemModules: SystemModule[] = [
    {
      ...
      items: [
        { name: "🏢 1. الفرع والشركة المالكة", href: "/onyx-erp?tab=branches&sub=company_and_branch_info", icon: Building2 },
        { name: "📍 2. الموقع والاتصال والـ GPS", href: "/onyx-erp?tab=branches&sub=location_and_contact", icon: MapPin },
        { name: "💳 3. البيانات المالية والضرائب", href: "/onyx-erp?tab=branches&sub=financial_and_tax", icon: DollarSign },
        ...
        { name: "إعدادات النظام العامة", href: "/settings", icon: Cpu }
      ]
    },
    {
      id: "sys_admin",
      ...
      systemKey: "sys_admin",
      items: [
        { name: "👥 المستخدمين والموظفين", href: "/onyx-erp?tab=sessions&sub=users_list", icon: Users },
        { name: "➕ إضافة موظف ومستخدم جديد", href: "/onyx-erp?tab=sessions&sub=users_list&subTask=add_user", icon: UserPlus },
        { name: "🌲 شجرة الصلاحيات والأدوار", href: "/onyx-erp?tab=sessions&sub=roles_tree", icon: ShieldCheck },
        { name: "🖥️ الجلسات والأجهزة النشطة", href: "/onyx-erp?tab=sessions&sub=active_sessions", icon: Clock },
        { name: "📜 سجل العمليات والرقابة", href: "/onyx-erp?tab=sessions&sub=audit_logs", icon: ShieldAlert },
        { name: "📊 تقارير الأمان", href: "/onyx-erp?tab=sessions&sub=security_reports", icon: BarChart3 },
        ...(isDeveloper ? [{ name: "إدارة التراخيص والتفعيل (المطور)", href: "/licenses", icon: KeyRound }] : []),
    ...
    },
    {
      ...
      items: [
        { name: "لوحة التحكم المالية", href: "/accounting?tab=dashboard", icon: TrendingUp },
        { name: "دليل الحسابات", href: "/accounting?tab=chart", icon: BookOpen },
        { name: "القيود وميزان المراجعة", href: "/accounting?tab=journal", icon: Scale },
        { name: "سندات القبض والصرف", href: "/accounting?tab=vouchers", icon: FileText },
        { name: "إدارة الصناديق", href: "/accounting?tab=safes", icon: Wallet },
        { name: "البنوك والتحويلات", href: "/accounting?tab=banks", icon: Landmark },
        { name: "كشوفات الحسابات", href: "/accounting?tab=statements", icon: FileSpreadsheet },
        { name: "الأصول والإهلاك", href: "/accounting?tab=assets", icon: Building2 },
        { name: "المصروفات المتكررة", href: "/accounting?tab=recurring", icon: Calendar },
        { name: "القوائم المالية الختامية", href: "/accounting?tab=financials", icon: Calculator },
        { name: "إدارة العملاء والذمم المدينة", href: "/customers", icon: Users },
