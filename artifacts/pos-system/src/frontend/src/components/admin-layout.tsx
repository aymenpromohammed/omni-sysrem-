...
import { LogOut, LayoutDashboard, Package, Tags, Receipt, Users, UserCircle, BarChart3, Settings, Printer, FileText, UserCheck, RotateCcw, Calculator, KeyRound } from "lucide-react";
...
export function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { name: "التراخيص", href: "/licenses", icon: KeyRound },
