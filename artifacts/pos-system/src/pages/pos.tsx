...
import { Trash2, Plus, Minus, Printer, ShoppingCart, X, UtensilsCrossed, Lock, KeyRound, ShieldCheck, Unlock } from "lucide-react";
              ...
              <>
                ...
                <div className="relative">
                  <Input
                    ...
                    className="w-56 h-7 text-sm text-center font-bold bg-amber-400/10 border-amber-400/40 text-amber-100 placeholder:text-amber-400/50 focus:bg-white focus:text-slate-900"
                    dir="rtl"
                    autoFocus
                  />
