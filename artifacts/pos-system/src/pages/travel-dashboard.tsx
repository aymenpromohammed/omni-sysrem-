...
import { Loader2, DollarSign, Plane, Ticket, Globe, Hotel, TrendingUp, AlertTriangle, Users, Wallet, ShieldAlert, Calendar, CheckCircle2 } from "lucide-react";
import {
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          <Card className="bg-slate-900 text-white">
            <CardContent className="p-4 flex items-center justify-between">
              <div>
                <p className="text-xs opacity-80">التذاكر المصدرة</p>
