...
function PrinterLayoutTab() {
  ...
  const defaults: PrinterSettingsInput & { mainPrinterName?: string | null } = {
    paperWidth: 80, leftMargin: 1.5, rightMargin: 1.5,
    ...
    <div className="space-y-4">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            عرض المحتوى = {form.paperWidth ?? 80}mm − {form.leftMargin ?? 1.5}mm − {form.rightMargin ?? 1.5}mm ={" "}
            <strong>{(form.paperWidth ?? 80) - (form.leftMargin ?? 1.5) - (form.rightMargin ?? 1.5)}mm</strong>
          </CardDescription>
        </CardHeader>
