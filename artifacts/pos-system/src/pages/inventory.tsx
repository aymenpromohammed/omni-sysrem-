...
export default function InventoryPage() {
  ...
  const getTabTitle = (tab: string) => {
    switch (tab) {
      ...
      case "vouchers": return "سندات الصرف والتحويلات";
  ...
  return (
    <AdminLayout>
      <div className="space-y-6 max-w-7xl mx-auto pb-12 dir-rtl">
            ...
            <Card>
              ...
              <CardContent className="p-0">
                <table className="w-full text-xs">
                  ...
                  <tbody className="divide-y divide-slate-100">
                    {summary?.purchaseReturns?.length === 0 ? (
                      <tr>
        ...
        {/* Tab 5: Issue Vouchers & Transfers */}
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-base font-bold flex items-center justify-between">
                    ...
                    <Button onClick={() => setShowIssueModal(true)} size="sm" className="bg-amber-500 hover:bg-amber-600 text-slate-950 font-bold text-xs">
                      + سند جديد
                    </Button>
                  </CardTitle>
                </CardHeader>
