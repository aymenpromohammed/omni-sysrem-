...
export default function LicensesPage() {
  ...
  // STRICT REQUIREMENT: Only developer role or developer username can access this page
            ...
            <table className="w-full text-xs">
              ...
              <tbody className="divide-y">
                {(licenses as any[]).map(l => {
                  ...
                  return (
                    <tbody key={l.id} className="divide-y">
                      <tr className="hover:bg-muted/30 transition-colors">
                        ...
                        <td className="p-3 text-center flex items-center justify-center gap-2">
                          <Button variant="ghost" size="icon" className="text-red-600 hover:bg-red-50 h-8 w-8 rounded-lg" onClick={() => confirm("هل أنت متأكد من حذف هذا الترخيص بالكامل؟") && delMut.mutate(l.id)}>
