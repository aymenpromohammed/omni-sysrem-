...
export default function Login() {
  ...
  const promoSlides = [
    {
      title: "نقاط بيع فائقة السرعة",
      desc: "واجهة كاشير ذكية تدعم اللمس السريع، الأوفلاين، ومزامنة فورية للفواتير والطلبات. مصممة لتقليل وقت انتظار العملاء.",
    ...
    },
    {
      ...
      desc: "راقب أرباحك، مبيعاتك، وحركة المخزون لحظة بلحظة من خلال لوحات تحكم ذكية ورسوم بيانية دقيقة من إتقان سوفت.",
      image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=600&q=80",
      icon: BarChart3,
      iconColor: "text-amber-300",
    },
    {
      title: "إدارة متكاملة للمطاعم والشركات",
      desc: "نظام أومني سيستم برو يوفر إدارة دقيقة للوصفات والمخازن مع دعم كامل للضريبة وتعدد الفروع.",
        ...
        <aside className="hidden lg:flex w-80 bg-gradient-to-b from-[#f8fafc] to-[#e2e8f0] border-l border-slate-300 flex-col py-6 shadow-inner relative overflow-y-auto custom-scrollbar">
          ...
          <div className="relative z-10 px-5 space-y-6">
            <div className="text-center space-y-2 mb-6">
              ...
              <h3 className="text-2xl font-black text-slate-900 tracking-tight">أومني سيستم برو</h3>
              <p className="text-sm font-bold text-blue-700">مستقبلك في إدارة الأعمال</p>
            </div>
            ...
            <div className="p-4 bg-gradient-to-l from-amber-100 to-amber-50 border border-amber-200 rounded-xl text-center shadow-sm">
              ...
              <p className="text-xs font-extrabold text-amber-900">أكثر من 5000 فرع حول العالم يثقون في أنظمتنا</p>
            </div>
          </div>
        </aside>
