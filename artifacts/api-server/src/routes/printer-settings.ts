...
function defaultSettings() {
  return { paperWidth: 80, leftMargin: 1.5, rightMargin: 1.5, topMargin: 1, bottomMargin: 1, fontSize: 10, lineSpacing: 2, charactersPerLine: 48, mainPrinterName: null };
}
...
router.put("/printer-settings", (req, res) => {
  ...
  `).run(
    b.paperWidth ?? 80, b.leftMargin ?? 1.5, b.rightMargin ?? 1.5,
