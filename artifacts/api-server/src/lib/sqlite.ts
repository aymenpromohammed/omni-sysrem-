...
function runMigrations() {
  ...
  // Standardize printer settings table
  try {
    db.exec(`INSERT OR IGNORE INTO printer_settings (id, paper_width, left_margin, right_margin, top_margin, bottom_margin, font_size, line_spacing, characters_per_line)
             VALUES (1, 80, 1.5, 1.5, 1, 1, 10, 2, 48)`);
  } catch {}
...
function seedData() {
  ...
  const products = [
    { number: 1, name: "برياني دجاج", price: 14000, cost: 8000, category_id: catIds[0], is_sellable: 1, show_in_pos: 1, item_type: "composite", stock: 15 },
    { number: 2, name: "رز أبيض", price: 6500, cost: 3000, category_id: catIds[0], is_sellable: 1, show_in_pos: 1, item_type: "sellable", stock: 100 },
    { number: 3, name: "دجاج مشوي", price: 18000, cost: 10000, category_id: catIds[0], is_sellable: 1, show_in_pos: 1, item_type: "sellable", stock: 40 },
    { number: 4, name: "لحم مشوي", price: 25000, cost: 15000, category_id: catIds[0], is_sellable: 1, show_in_pos: 1, item_type: "sellable", stock: 25 },
    { number: 5, name: "سمك مقلي", price: 20000, cost: 12000, category_id: catIds[0], is_sellable: 1, show_in_pos: 1, item_type: "sellable", stock: 20 },
    { number: 6, name: "عصير برتقال", price: 3000, cost: 1000, category_id: catIds[1], is_sellable: 1, show_in_pos: 1, item_type: "sellable", stock: 80 },
    { number: 7, name: "شاي", price: 1500, cost: 500, category_id: catIds[1], is_sellable: 1, show_in_pos: 1, item_type: "sellable", stock: 150 },
    { number: 8, name: "ماء معدني", price: 1000, cost: 300, category_id: catIds[1], is_sellable: 1, show_in_pos: 1, item_type: "sellable", stock: 300 },
    { number: 9, name: "كولا", price: 2000, cost: 800, category_id: catIds[1], is_sellable: 1, show_in_pos: 1, item_type: "sellable", stock: 200 },
    { number: 10, name: "كيك شوكولاتة", price: 5000, cost: 2500, category_id: catIds[2], is_sellable: 1, show_in_pos: 1, item_type: "sellable", stock: 30 },
    { number: 11, name: "آيس كريم", price: 4000, cost: 1500, category_id: catIds[2], is_sellable: 1, show_in_pos: 1, item_type: "sellable", stock: 50 },
    { number: 12, name: "شاورما دجاج", price: 8000, cost: 4000, category_id: catIds[3], is_sellable: 1, show_in_pos: 1, item_type: "sellable", stock: 60 },
    { number: 13, name: "شاورما لحم", price: 10000, cost: 5000, category_id: catIds[3], is_sellable: 1, show_in_pos: 1, item_type: "sellable", stock: 45 },
    { number: 14, name: "فتة", price: 8000, cost: 4000, category_id: catIds[0], is_sellable: 1, show_in_pos: 1, item_type: "sellable", stock: 35 },
    { number: 15, name: "مرق لحم", price: 5000, cost: 2000, category_id: catIds[0], is_sellable: 1, show_in_pos: 1, item_type: "sellable", stock: 40 },
    // Raw materials & Packaging (Decoupled Inventory-only items)
    { number: 16, name: "أرز بسمتي", price: 0, cost: 3500, category_id: catIds[0], is_sellable: 0, show_in_pos: 0, item_type: "raw_material", stock: 150, unit: "كجم" },
    { number: 17, name: "دجاج طازج", price: 0, cost: 6000, category_id: catIds[0], is_sellable: 0, show_in_pos: 0, item_type: "raw_material", stock: 80, unit: "حبة" },
    { number: 18, name: "علبة سفري فاخرة", price: 0, cost: 800, category_id: catIds[0], is_sellable: 0, show_in_pos: 0, item_type: "packaging", stock: 500, unit: "حبة" },
    { number: 19, name: "صلصة برياني سرية", price: 0, cost: 1500, category_id: catIds[0], is_sellable: 0, show_in_pos: 0, item_type: "semi_finished", stock: 50, unit: "لتر" },
    { number: 20, name: "أكياس بلاستيك سفري", price: 0, cost: 150, category_id: catIds[0], is_sellable: 0, show_in_pos: 0, item_type: "packaging", stock: 1000, unit: "حبة" },
    { number: 21, name: "صابون غسيل أواني", price: 0, cost: 2500, category_id: catIds[0], is_sellable: 0, show_in_pos: 0, item_type: "supplies", stock: 10, unit: "جالون" }
  ];
  ...
  for (const p of products) {
    insertProd.run(p.number, p.name, p.price, p.cost, p.category_id, p.is_sellable, p.show_in_pos, p.item_type, p.stock, p.unit ?? "حبة");
  }

  // Seed sample recipes
  const insertRecipe = db.prepare(
    "INSERT INTO product_recipes (product_id, ingredient_name, quantity, unit) VALUES (?,?,?,?)"
  );
  // Product 1 (برياني دجاج) uses Rice, Chicken, Takeout box, and secret sauce
  insertRecipe.run(1, "أرز بسمتي", 0.25, "كجم");
  insertRecipe.run(1, "دجاج طازج", 0.5, "حبة");
  insertRecipe.run(1, "علبة سفري فاخرة", 1, "حبة");
  insertRecipe.run(1, "صلصة برياني سرية", 0.1, "لتر");
